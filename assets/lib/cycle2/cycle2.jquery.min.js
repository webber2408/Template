    ...
    e.fn.cycle = function(i) {
        ...
        return 0 !== this.length || e.isReady ? this.each(function() {
            ...
            if (!l.data("cycle.opts")) {
                (!1 === l.data("cycle-log") || i && !1 === i.log || s && !1 === s.log) && (r = e.noop), r("--c2 init--"), n = l.data();
        ...
        queueTransition: function(t, i) {
            ...
            }, s) : n.API.trigger("cycle-finished", [n]), void(n.nextSlide = n.currSlide)) : void 0 !== n.continueAuto && (!1 === n.continueAuto || e.isFunction(n.continueAuto) && !1 === n.continueAuto()) ? (n.API.log("terminating automatic transitions"), n.timeout = 0, void(n.timeoutId && clearTimeout(n.timeoutId))) : void(s && (n._lastQueue = e.now(), void 0 === i && (n._remainingTimeout = t.timeout), n.paused || n.hoverPaused || (n.timeoutId = setTimeout(function() {
            ...
            r && (t.css("visibility", "hidden").appendTo("body").each(function(t) {
                ...
                return d.data("index", t), (u = u.filter(":not(.cycle-loader-ignore)").filter(':not([src=""])')).length ? (a = u.length, void u.each(function() {
                    this.complete ? l() : e(this).load(function() {
                        ...
                        0 == --a && (i.API.log("slide skipped; po not loaded:", this.src), 0 == --r && "wait" == i.loader && n.apply(i.API, [c, s]))
                    })
                })) : (--r, void c.push(d))
